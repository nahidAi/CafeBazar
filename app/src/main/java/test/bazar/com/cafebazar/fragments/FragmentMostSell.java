...
public class FragmentMostSell extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_most_sell, container, false);
        setupViews();
    ...
    private void setupViews() {
        ...
        progressBar = view.findViewById(R.id.progressBar_fragmentMostSell);
        imgSlide = view.findViewById(R.id.img_fragmentMostSell);
